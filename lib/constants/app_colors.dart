...
class AppColors {
  ...
  static Color purple = Color.fromARGB(255, 136, 3, 141);
  static Color buttonColor = Color.fromARGB(255, 238, 4, 238);
  static Color iconColor = Color.fromARGB(255, 243, 102, 149);
  static Color textColor = Color.fromARGB(255, 248, 248, 248);
  static Color receiverChatBubble = Color.fromARGB(255, 26, 121, 216);
